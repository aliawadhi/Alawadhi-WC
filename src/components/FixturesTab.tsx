...
const TEAM_RANKS: Record<string, number> = {
    ...
    'IR Iran': 21, 'Türkiye': 22, 'Ecuador': 23, 'Austria': 24, 'Korea Republic': 25,
    'Nigeria': 26, 'Australia': 27, 'Algeria': 28, 'Egypt': 29, 'Canada': 30,
    'Norway': 31, 'Ukraine': 32, 'Panama': 33, "Côte d'Ivoire": 34, 'Poland': 35,
    'Sweden': 38, 'Paraguay': 40, 'Czechia': 41, 'Scotland': 43, 'Tunisia': 44, 'Cameroon': 45,
    'Congo DR': 46, 'Uzbekistan': 50, 'Costa Rica': 51, 'Mali': 52, 'Chile': 54,
